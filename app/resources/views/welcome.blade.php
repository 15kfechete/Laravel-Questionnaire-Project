    ...
    <div class="card-section">
        <div class="grid-x">
            <div class="cell small-10">
                <p class="lead">Click here to gain access to the various tools and features included to create ad manage
                    your own Questionnaires!</p>
            </div>
            <div class="cell small-2">
                <a href="/home" class="button">Access Questionnaires</a>
                <? // Link to Access Questionnaires ?>
            </div>
        </div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-section">
        <div class="grid-x">
            <div class="cell small-10">
                <p class="lead">Click here to access all of the available questionnaires outputed by its various
                    researchers!</p>
            </div>
            <div class="cell small-2">
